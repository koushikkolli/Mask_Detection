...
detection_graph2, sess2 = detector_utils.load_inference_graph_2()
    ...
    try:
        while True:
           ...
           # print(classes1)
            ...
            a, b = detector_utils.draw_box_on_image1(
                num_hands_detect, 0.4, scores1, boxes1, classes1, im_width, im_height, frame, Line_Position2,
                Orientation)
            lst1.append(a)
            lst2.append(b)
